    ...
    public partial class frmHoGiaDinh : Form
    {
        ...
        void GanDuLieu()
        {
            if (dtHoGiaDinh.Rows.Count > 0)
            {
                ...
                {
                    dtkNgayLap.Value = DateTime.Parse(dgvHoGiaDinh[2,
                        dgvHoGiaDinh.CurrentRow.Index].Value.ToString());
                }
        ...
        {
            if (btnThemClicked == true)
            {
                cbbMaAp.ValueMember = "TenAp";
                cbbTenAp.SelectedIndex = cbbTenAp.FindString(cbbMaAp.SelectedValue.ToString());
            }
            else
            {
                cbbMaAp.ValueMember = "MaAp";
                btnThemClicked = false;
            }
        }
